...
We're looking for interns who see manual work and instinctively think: *"Why isn't an agent doing this?"*
...
- **What's one thing about Single Grain that makes you want to intern here specifically?**
- **What's the most impressive thing you've built or shipped?** Link it, screenshot it, or describe it with enough detail that we could verify it.

Don't overthink this section. Be direct.

---

## Part 2: Agentify a Manual Workflow

This is the core of your submission. **You need to build something.**
...
- A working prototype, even if it's rough
...
Submit as PDF, Markdown, or a link to your repo/demo. **Maximum 4 pages** for the written portion (code repos and video demos don't count toward the limit). Estimated time: 1-2 hours.
