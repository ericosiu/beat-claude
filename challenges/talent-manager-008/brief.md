...
- Strategic Depth (30 pts) — Do you understand the full scope of building a people function, not just posting jobs?
- Specificity (25 pts) — Name the tools. Design the review cycle. Write the comp bands. Could we execute this tomorrow?
- AI Fluency (20 pts) — We want a genuinely AI-native people function, not AI as an afterthought
- Creativity (15 pts) — Agency people problems are notoriously hard. Show us something we haven't seen
- Communication (10 pts) — Reads like a strategy doc for the CEO, not an HR textbook
